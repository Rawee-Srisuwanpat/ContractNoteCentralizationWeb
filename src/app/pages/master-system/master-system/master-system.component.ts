...
@Component({
  selector: 'app-master-system',
  templateUrl: './master-system.component.html',
  styleUrls: ['./master-system.component.scss'],
})
export class MasterSystemComponent implements OnInit, AfterViewInit {
